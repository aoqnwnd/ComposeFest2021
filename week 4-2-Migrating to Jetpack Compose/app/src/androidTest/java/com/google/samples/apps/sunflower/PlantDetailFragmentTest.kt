...
class PlantDetailFragmentTest {
    ...
    //액티비티 또는 프래그먼트가 컴포즈를 사용하는 경우 ActivityScenarioRule을 사용하는 대신
    // Compose 코드를 테스트할 수 있는 ComposeTestRule과 ActivityScenarioRule을 통합하는
    // createAndroidComposeRule을 사용해야 한다.
    @Rule
    @JvmField
